...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmVkYW50MTAxIiwiYSI6ImNraHQzY2VsazF3ZWwydWs2ZzVnYnd3Z2UifQ.5jZ1x7QI-cX_ceyDAHfIOQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/vedant101/ckhvl3hxt0hrh19okbhiinfd9',
    scrollZoom: false // center: [-118.23571290288807, 34.03408086579255],
    // zoom: 6,
    // interactive: false,
...
function validatePassword() {
  var password_signup = document.getElementById('passwordSignup');
  var confirm_password_signup = document.getElementById('passwordConfirmSignup');
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, password, passwordConfirm, role, photo) {
    var result;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var stripe = Stripe('pk_test_51HridXEFD5r5oGCQEmDuf5FlAt9T9e2jBQabLtW6yx4344WsYbMTDJG4q7gX3tZw7LUF7YJnB1JMmJxSPVz8CVCN00jJCVpRjg');
...
var updateSettingsForm = document.querySelector('#updateSettingsForm');
...
if (password_signup) {
  password_signup.onchange = _signup.validatePassword;
  confirm_password_signup.onkeyup = _signup.validatePassword;
}
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    var passwordConfirmSignup = document.getElementById('passwordConfirmSignup').value;
    var role = 'user';
    var photo = 'default.jpg';
    (0, _signup.signup)(name, email, passwordSignup, passwordConfirmSignup, role, photo);
  });
}
